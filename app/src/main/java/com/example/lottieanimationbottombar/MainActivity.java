package com.example.lottieanimationbottombar;
import static com.example.lottieanimationbottombar.lottiebottomnav.MenuItem.Source.Assets;
...
import com.example.lottieanimationbottombar.lottiebottomnav.FontBuilder;
import com.example.lottieanimationbottombar.lottiebottomnav.FontItem;
import com.example.lottieanimationbottombar.lottiebottomnav.ILottieBottomNavCallback;
import com.example.lottieanimationbottombar.lottiebottomnav.LottieBottomNav;
import com.example.lottieanimationbottombar.lottiebottomnav.MenuItem;
import com.example.lottieanimationbottombar.lottiebottomnav.MenuItemBuilder;
...
public class MainActivity extends AppCompatActivity implements ILottieBottomNavCallback, MailFragment.ClickHandler {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        MenuItem item1 = MenuItemBuilder.create("home.json", Assets, fontItem, "dash")
                .pausedProgress(1f)
                .loop(false)
                .build();
